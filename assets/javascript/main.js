  ...
  if (!noUsersCity) {
    $("#dislike").on("click", function () {
      ...
      if (placeArr[restIndex] === undefined) {
        $("#restaurant").empty().addClass("expand").append("<button class='keep'> Keep searching?").attr("class", "col m8 center-align");
        $("#restaurant").children(".keep").attr("class", "btn-large waves-effect waves-dark grey")
      }
    });
...
function likedDiv() {
  $("#liked-row").prepend("<div class='col m4 s12 newLiked" + restIndex + "'>");
